...
import { duckJadiBot } from './features/sockets-serbot.js'
...
import { makeWASocket, protoType, serialize } from './core/simple.js'
...
const pluginFolder = global.__dirname(join(__dirname, './features/index'))
