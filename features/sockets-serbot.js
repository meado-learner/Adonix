...
const { CONNECTING } = ws
import { makeWASocket } from '../core/simple.js'
...
let drm1 = ""
let drm2 = ""
let rtx = "「✦」 *VINCULACION • CÓDIGO QR*\n\n> ꕥ Acción » Escanea este QR para ser un *Sub-Bot* temporal\n> ❑ Paso 1 » Clic en ⋮ (esquina superior)\n> ❑ Paso 2 » Dispositivos vinculados\n> ❑ Paso 3 » Escanea el QR"
let rtx2 = "「✦」 *VINCULACION • CODIGO DE 8 DÍGITOS*\n\n> ꕥ Acción » Usa este código para ser un *Sub-Bot* temporal\n> ❑ Paso 1 » Clic en ⋮ (esquina superior)\n> ❑ Paso 2 » Dispositivos vinculados\n> ❑ Paso 3 » Vincular con número\n> ❑ Paso 4 » Ingresa el código\n> ⴵ Recomendación » No usar la cuenta principal\n> ☁︎ Nota » Temporal y seguro"
...
let handler = await import('../events.js')
let creloadHandler = async function (restatConn) {
try {
const Handler = await import(`../events.js?update=${Date.now()}`).catch(console.error)
