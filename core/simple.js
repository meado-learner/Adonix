...
export function makeWASocket(connectionOptions, options = {}) {
    ...
    conn.sendMessage = async function(jid, content, options = {}) {
        ...
        if (global.rcanal === true && !content.react && !newContent.contextInfo?.externalAdReply) {
            try {
                const thumbnail = await (await fetch(global.banner)).buffer()
                ...
                console.error("Error al adjuntar la información del canal:", e);
            }
        }
